...
public class Gun extends Weapon {
    ...
    public void updateGunTip(Point playerPosition) {
        ...
        this.angle = Math.atan2(cursorPosition.y - centerY, cursorPosition.x - centerX - Math.PI);
    ...
    public void render(Graphics g, int playerX, int playerY, boolean facingRight) {
        ...
        int renderX = playerX + 9 - rotatedGun.getWidth() / 2; // Adjust for horizontal positioning
