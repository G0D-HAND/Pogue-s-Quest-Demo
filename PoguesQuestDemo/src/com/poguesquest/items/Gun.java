...
public class Gun extends Weapon {
    ...
    public void updateGunTip(Point playerPosition) {
        ...
        int centerX = playerPosition.x; // Half width of the hitbox
        int centerY = playerPosition.y + 20; // Player's stomach area (center of player)
        ...
        int gunTipX = (int) (centerX + 5+ Math.cos(angle) * gunLength);
        int gunTipY = (int) (centerY - 7+ Math.sin(angle) * gunLength);
    ...
    public void render(Graphics g, int playerX, int playerY, boolean facingRight) {
        ...
        int renderX = playerX + 20 - rotatedGun.getWidth() / 2; // Adjust for horizontal positioning
        int renderY = playerY + 15 - rotatedGun.getHeight() / 2; // Adjust for vertical positioning
        ...
        if (mirrorHorizontal) {
            ...
            g2d.scale(-1, 1);
            g2d.drawImage(rotatedGun, 0 + 10, 0 + 2, null);
        } else {
            // Render normally
            g2d.drawImage(rotatedGun, renderX, renderY + 2, null);
        }
